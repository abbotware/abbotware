// -----------------------------------------------------------------------
// <copyright file="ILookUp{T1,T2,TValue}.cs" company="Abbotware, LLC">
...
namespace Abbotware.Core.Collections
{
    ...
    public interface ILookup<T1, T2, out TValue>
        where T1 : notnull
        where T2 : notnull
    {
        /// <summary>
        ...
        TValue this[T1 key1, T2 key2] { get; }
