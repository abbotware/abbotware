namespace Abbotware.UnitTests.Quant.Finance
{
    ...
    public class DiscountFactorTests
    {
        ...
        public void DiscountFactor_Continuous()
        {
            ...
            Assert.That(r1, Is.EqualTo(0.7866).Within(DoublePrecision.Low));
        }
        ...
        public void DiscountFactor_Discrete()
        {
            ...
            Assert.That(r1, Is.EqualTo(0.7867).Within(DoublePrecision.Low));
            var r2 = DiscountFactor.Discrete(.12, 12, 2);
            Assert.That(r2, Is.EqualTo(0.7876).Within(DoublePrecision.Low));
            var r3 = DiscountFactor.Discrete(.12, 4, 2);
            Assert.That(r3, Is.EqualTo(0.7894).Within(DoublePrecision.Low));
            var r4 = DiscountFactor.Discrete(.12, 2, 2);
            Assert.That(r4, Is.EqualTo(0.7921).Within(DoublePrecision.Low));
            var r5 = DiscountFactor.Discrete(.12, 1, 2);
            Assert.That(r5, Is.EqualTo(0.7972).Within(DoublePrecision.Low));
        }
    }
}
