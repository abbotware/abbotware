...
namespace Abbotware.Interop.TDAmeritrade.Models
{
    ...
    public record Instrument([property: MaxLength(Length.Cusip)] string? Cusip, [property: Key][property: MaxLength(TDAmeritradeConstants.SymbolLength)] string Symbol, [property: MaxLength(250)] string? Description, ExchangeType Exchange, AssetType AssetType)
    {
        /// <summary>
