...
namespace Abbotware.Interop.Aws.Timestream.Protocol.Builder
{
        ...
        where TProperty : notnull
    {
        ...
        public DimensionValueBuilderOptions(string name, DimensionValueType measureValueType, Func<TMessage, TProperty> function, Func<TProperty, string> converter)
        ...
        public DimensionValueOptions<TMessage, TProperty> Build()
        {
            return new DimensionValueOptions<TMessage, TProperty>(this.ValueType, this.Function, this.Converter, string.Empty, this.Name);
        }
    }
}