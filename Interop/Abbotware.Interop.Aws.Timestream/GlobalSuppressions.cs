...
[assembly: SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "ownership transfer", Scope = "member", Target = "~M:Abbotware.Interop.Aws.Timestream.PocoPublisher`1.#ctor(Abbotware.Interop.Aws.Timestream.Configuration.TimestreamOptions,Abbotware.Core.Logging.ILogger)")]
[assembly: SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "ownership transfer", Scope = "member", Target = "~M:Abbotware.Interop.Aws.Timestream.TimestreamPublisher`1.#ctor(Abbotware.Interop.Aws.Timestream.Configuration.TimestreamOptions,Abbotware.Interop.Aws.Timestream.Protocol.ITimestreamProtocol{`0},Abbotware.Core.Logging.ILogger)")]
