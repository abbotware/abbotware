...
namespace Abbotware.Interop.Aws.Timestream.Protocol
{
    ...
    public static partial class ProtocolBuilderExtensions
    {
        ...
        /// <param name="configure">configure callback</param>
        /// <returns>builder</returns>
        public static IProtocolBuilder<TMessage> AddMeasure<TMessage>(this IProtocolBuilder<TMessage> builder, string name, Func<TMessage, ulong?> function, Action<NullableMeasureValueBuilderOptions<TMessage, ulong?>>? configure = null)
                 where TMessage : notnull
        {
