// -----------------------------------------------------------------------
// <copyright file="ProtocolBuilder.Measure-BigInt-Int16.cs" company="Abbotware, LLC">
...
namespace Abbotware.Interop.Aws.Timestream.Protocol
{
    ...
    public static partial class ProtocolBuilderExtensions
    {
        ...
        /// <param name="configure">configure callback</param>
        /// <returns>builder</returns>
        public static IProtocolBuilder<TMessage> AddMeasure<TMessage>(this IProtocolBuilder<TMessage> builder, string name, Func<TMessage, short> function, Action<MeasureValueBuilderOptions<TMessage, short>>? configure = null)
            where TMessage : notnull
        {
            var options = new MeasureValueBuilderOptions<TMessage, short>(name, MeasureValueType.BIGINT, function, x => x.ToString(CultureInfo.InvariantCulture));
