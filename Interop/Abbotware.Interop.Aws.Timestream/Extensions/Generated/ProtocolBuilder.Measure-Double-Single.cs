// -----------------------------------------------------------------------
// <copyright file="ProtocolBuilder.Measure-Double-Single.cs" company="Abbotware, LLC">
...
namespace Abbotware.Interop.Aws.Timestream.Protocol
{
    ...
    public static partial class ProtocolBuilderExtensions
    {
        ...
        /// <param name="configure">configure callback</param>
        /// <returns>builder</returns>
        public static IProtocolBuilder<TMessage> AddMeasure<TMessage>(this IProtocolBuilder<TMessage> builder, string name, Func<TMessage, float> function, Action<MeasureValueBuilderOptions<TMessage, float>>? configure = null)
            where TMessage : notnull
        {
            var options = new MeasureValueBuilderOptions<TMessage, float>(name, MeasureValueType.DOUBLE, function, x => x.ToString(CultureInfo.InvariantCulture));
