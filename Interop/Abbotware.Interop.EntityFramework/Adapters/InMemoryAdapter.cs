// -----------------------------------------------------------------------
// <copyright file="InMemoryAdapter.cs" company="Abbotware, LLC">
...
namespace Abbotware.Interop.EntityFramework.Adapters
{
    ...
    public class InMemoryAdapter<TContext> : IDbContextOptionsAdapter<TContext>
           where TContext : DbContext
    {
        ...
        public DbContextOptions<TContext> Convert(ISqlConnectionOptions from)
        {
            ...
            optionsBuilder.UseInMemoryDatabase(from.ConnectionString);
